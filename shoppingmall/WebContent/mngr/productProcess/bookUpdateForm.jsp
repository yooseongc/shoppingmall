		...
		<ul>
			...
			<li>
				...
				<input id="book_title" name="book_title" type="text" 
					size="50" placeholder="제목" maxlength="50" value="${ book_id }">
			</li>
			<li>
				<label for="book_price">가격</label>
				<input id="book_price" name="book_price" type="text"
					size="10" placeholder="가격" maxlength="9" value="${ book.book_price }">원
			</li>
			<li>
				<label for="book_count">수량</label>
				<input id="book_count" name="book_count" type="text"
					size="10" placeholder="수량" maxlength="5" value="${ book.book_count }">권
			</li>
			<li>
			...
			<li>
				...
				<input id="discount_rate" name="discount_rate" type="text" size="5" 
					placeholder="10" maxlength="2">
			</li>
			<li class="label2">
				<input type="submit" id="registBook" value="책수정">
			</li>
		</ul>
	</div>
</form>
